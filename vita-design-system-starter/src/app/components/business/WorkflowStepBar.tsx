          ...
          >
            <div
              className={`flex h-8 w-8 items-center justify-center rounded-full text-sm ${
                isActive ? "bg-primary text-primary-foreground" : isDone ? "bg-success-600 text-success-foreground" : "bg-muted"
              }`}
            >
              {index + 1}
            </div>
            <div>
              <div className={`text-sm ${isActive ? "font-medium" : "font-normal"}`}>{step.label}</div>
